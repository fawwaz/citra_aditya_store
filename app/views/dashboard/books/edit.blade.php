		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					{{ Form::model($book, array('route' => array('books.update', $book->id), 'method' => 'PUT','class'=>'form-horizontal' , 'files'=>true)) }}	
					...
					<div class="row">
						<div class="col-md-6">
							...
							{{ Form::text('total_page', null, array('class' => 'form-control')) }}
							...
							<select multiple="multiple" name="authors[]" id="authors">
								...
								<option value="{{$author->id}}" @foreach($book->authors as $a) @if($author->id == $a->id) selected="true" @endif @endforeach>{{$author->name}}</option>
								@endforeach
							</select>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									@if(File::exists(public_path().'/uploads/books/'.$book->id.'.jpg'))
										{{HTML::image('/uploads/books/'.$book->id.'.jpg',$book->title,array('class'=>'img-thumbnail text-center'))}}
									@else
										You should put default image here.
									@endif
									{{Form::file('image')}}
					...
					{{ Form::textarea('toc', null, array('class' => 'form-control')) }}
					<p class="help-block">Deskripsi Riwayat hidup penulis -- improvement : make text-editor kaya tinymce</p>
